...
date: 2020-05-28 18:45:00 -0700
permalink: /projects/Markov-Chain-Name-Generator
excerpt: "Generate new names that follow the patterns in real names."
---

This program generates names that, although original, look and soound like they could be real names. By learning from over 4,000 names, the program recognizes common sequences of letters, then uses those patterns to generate the new names.
